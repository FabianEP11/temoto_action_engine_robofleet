...
flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<fb::temoto_action_engine::BroadcastStopUmrfGraph>>> RostoFb(flatbuffers::FlatBufferBuilder& fbb, const std::vector<temoto_action_engine::BroadcastStopUmrfGraph>& msg);
...
namespace temoto_action_engine_robofleet {
  ...
  /** Publish Handler **/
  class BroadcastStopUmrfGraphPublishHandler : public robofleet_client::ROSPublishHandler
  {
  public:
  ...
  private:
    typedef temoto_action_engine::BroadcastStopUmrfGraph MsgType;
    typedef fb::temoto_action_engine::BroadcastStopUmrfGraph FbMsgType;
  ...
  /** Subscribe Handler **/
  class BroadcastStopUmrfGraphSubscribeHandler : public robofleet_client::ROSSubscribeHandler
  {
  public:
