...
inline BroadcastStartUmrfGraphT::BroadcastStartUmrfGraphT(const BroadcastStartUmrfGraphT &o)
  ...
  for (const auto &v : o.umrf_graph_diffs) { umrf_graph_diffs.emplace_back((v) ? new fb::temoto_action_engine::UmrfGraphDiffT(*v) : nullptr); }
}
...
inline void GetUmrfGraphsRequest::UnPackTo(GetUmrfGraphsRequestT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  (void)_resolver;
  { auto _e = __metadata(); if (_e) { if(_o->__metadata) { _e->UnPackTo(_o->__metadata.get(), _resolver); } else { _o->__metadata = std::unique_ptr<fb::MsgMetadataT>(_e->UnPack(_resolver)); } } }
  { auto _e = requested_graphs(); if (_e) { _o->requested_graphs.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->requested_graphs[_i] = _e->Get(_i)->str(); } } }
}
...
inline void GetUmrfGraphsResponse::UnPackTo(GetUmrfGraphsResponseT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  (void)_resolver;
  { auto _e = __metadata(); if (_e) { if(_o->__metadata) { _e->UnPackTo(_o->__metadata.get(), _resolver); } else { _o->__metadata = std::unique_ptr<fb::MsgMetadataT>(_e->UnPack(_resolver)); } } }
  { auto _e = umrf_graph_jsons(); if (_e) { _o->umrf_graph_jsons.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->umrf_graph_jsons[_i] = _e->Get(_i)->str(); } } }
}
